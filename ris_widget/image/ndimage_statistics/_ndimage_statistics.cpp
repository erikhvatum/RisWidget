...
/* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":37
...
static PyObject *__pyx_f_10ris_widget_19_ndimage_statistics_hist_min_max_uint16(__Pyx_memviewslice __pyx_v_arr, __Pyx_memviewslice __pyx_v_hist, __Pyx_memviewslice __pyx_v_min_max, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":38
 * 
 * cpdef hist_min_max_uint16(numpy.uint16_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint16_t[:] min_max):
 *     assert hist.shape[0] == 1024             # <<<<<<<<<<<<<<
 *     _hist_min_max_uint16(&arr[0][0], &arr.shape[0], &arr.strides[0],
 ...
 */
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":39
 * cpdef hist_min_max_uint16(numpy.uint16_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint16_t[:] min_max):
 *     assert hist.shape[0] == 1024
 *     _hist_min_max_uint16(&arr[0][0], &arr.shape[0], &arr.strides[0],             # <<<<<<<<<<<<<<
 *                          &hist[0], &min_max[0])
...
__pyx_t_2 = 0;
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":40
 *     assert hist.shape[0] == 1024
 *     _hist_min_max_uint16(&arr[0][0], &arr.shape[0], &arr.strides[0],
 *                          &hist[0], &min_max[0])             # <<<<<<<<<<<<<<
 * 
...
/* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":42
 *                          &hist[0], &min_max[0])
 * 
 * cpdef hist_min_max_uint12(numpy.uint16_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint16_t[:] min_max):             # <<<<<<<<<<<<<<
 *     assert hist.shape[0] == 1024
...
static PyObject *__pyx_f_10ris_widget_19_ndimage_statistics_hist_min_max_uint12(__Pyx_memviewslice __pyx_v_arr, __Pyx_memviewslice __pyx_v_hist, __Pyx_memviewslice __pyx_v_min_max, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":43
 * 
 * cpdef hist_min_max_uint12(numpy.uint16_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint16_t[:] min_max):
 *     assert hist.shape[0] == 1024             # <<<<<<<<<<<<<<
 *     _hist_min_max_uint12(&arr[0][0], &arr.shape[0], &arr.strides[0],
 ...
 */
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":44
 * cpdef hist_min_max_uint12(numpy.uint16_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint16_t[:] min_max):
 *     assert hist.shape[0] == 1024
 *     _hist_min_max_uint12(&arr[0][0], &arr.shape[0], &arr.strides[0],             # <<<<<<<<<<<<<<
 *                          &hist[0], &min_max[0])
...
__pyx_t_2 = 0;
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":45
 *     assert hist.shape[0] == 1024
 *     _hist_min_max_uint12(&arr[0][0], &arr.shape[0], &arr.strides[0],
 *                          &hist[0], &min_max[0])             # <<<<<<<<<<<<<<
 * 
...
/* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":47
 *                          &hist[0], &min_max[0])
 * 
 * cpdef hist_min_max_uint8(numpy.uint8_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint8_t[:] min_max):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_f_10ris_widget_19_ndimage_statistics_hist_min_max_uint8(__Pyx_memviewslice __pyx_v_arr, __Pyx_memviewslice __pyx_v_hist, __Pyx_memviewslice __pyx_v_min_max, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":48
 * 
 * cpdef hist_min_max_uint8(numpy.uint8_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint8_t[:] min_max):
 *     assert hist.shape[0] == 256             # <<<<<<<<<<<<<<
 *     _hist_min_max_uint8(&arr[0][0], &arr.shape[0], &arr.strides[0],
 ...
 */
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":49
 * cpdef hist_min_max_uint8(numpy.uint8_t[:, :] arr, numpy.uint32_t[:] hist, numpy.uint8_t[:] min_max):
 *     assert hist.shape[0] == 256
 *     _hist_min_max_uint8(&arr[0][0], &arr.shape[0], &arr.strides[0],             # <<<<<<<<<<<<<<
 *                          &hist[0], &min_max[0])
...
__pyx_t_2 = 0;
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":50
 *     assert hist.shape[0] == 256
 *     _hist_min_max_uint8(&arr[0][0], &arr.shape[0], &arr.strides[0],
 *                          &hist[0], &min_max[0])             # <<<<<<<<<<<<<<
 * 
...
/* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":55
...
static PyObject *__pyx_f_10ris_widget_19_ndimage_statistics_hist_min_max_float32(__Pyx_memviewslice __pyx_v_arr, __Pyx_memviewslice __pyx_v_hist, __Pyx_memviewslice __pyx_v_min_max, __pyx_t_5numpy_float32_t __pyx_v_hist_min, __pyx_t_5numpy_float32_t __pyx_v_hist_max, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":57
 * cpdef hist_min_max_float32(numpy.float32_t[:, :] arr, numpy.uint32_t[:] hist, numpy.float32_t[:] min_max, numpy.float32_t hist_min, numpy.float32_t hist_max):
 *     cdef numpy.float32_t v
 *     cdef numpy.uint32_t n_bins = hist.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":59
 *     cdef numpy.uint32_t n_bins = hist.shape[0]
 *     cdef Py_ssize_t i, j, bin
 *     cdef numpy.float32_t bin_factor = (n_bins - 1) / (hist_max - hist_min)             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":60
 *     cdef Py_ssize_t i, j, bin
 *     cdef numpy.float32_t bin_factor = (n_bins - 1) / (hist_max - hist_min)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         hist[:] = 0
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":61
 *     cdef numpy.float32_t bin_factor = (n_bins - 1) / (hist_max - hist_min)
 *     with nogil:
 *         hist[:] = 0             # <<<<<<<<<<<<<<
 *         min_max[0] = arr[0,0]
...

{
        ...
        /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":62
 *     with nogil:
 *         hist[:] = 0
 *         min_max[0] = arr[0,0]             # <<<<<<<<<<<<<<
 *         min_max[1] = arr[0,0]
 ...
 */
        ...
        *((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_min_max.data + __pyx_t_4 * __pyx_v_min_max.strides[0]) )) = (*((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_2 * __pyx_v_arr.strides[0]) ) + __pyx_t_3 * __pyx_v_arr.strides[1]) )));
        ...
        /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":63
 *         hist[:] = 0
 *         min_max[0] = arr[0,0]
 *         min_max[1] = arr[0,0]             # <<<<<<<<<<<<<<
 *         for i in range(arr.shape[0]):
 ...
 */
        ...
        *((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_min_max.data + __pyx_t_7 * __pyx_v_min_max.strides[0]) )) = (*((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_arr.data + __pyx_t_5 * __pyx_v_arr.strides[0]) ) + __pyx_t_6 * __pyx_v_arr.strides[1]) )));
        ...
        /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":64
 *         min_max[0] = arr[0,0]
 *         min_max[1] = arr[0,0]
 *         for i in range(arr.shape[0]):             # <<<<<<<<<<<<<<
 *             for j in range(arr.shape[1]):
 ...
 */
        ...
        for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
          ...
          /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":65
 *         min_max[1] = arr[0,0]
 *         for i in range(arr.shape[0]):
 *             for j in range(arr.shape[1]):             # <<<<<<<<<<<<<<
 *                 v = arr[i, j]
 ...
 */
          ...
          for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
            ...
            /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":66
 *         for i in range(arr.shape[0]):
 *             for j in range(arr.shape[1]):
 *                 v = arr[i, j]             # <<<<<<<<<<<<<<
 *                 bin = <Py_ssize_t> (bin_factor * (v - hist_min))
 ...
 */
            ...
            /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":67
 *             for j in range(arr.shape[1]):
 *                 v = arr[i, j]
 *                 bin = <Py_ssize_t> (bin_factor * (v - hist_min))             # <<<<<<<<<<<<<<
 *                 hist[bin] += 1
 ...
 */
            ...
            /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":68
 *                 v = arr[i, j]
 *                 bin = <Py_ssize_t> (bin_factor * (v - hist_min))
 *                 hist[bin] += 1             # <<<<<<<<<<<<<<
 *                 if v < min_max[0]:
 ...
 */
            ...
            *((__pyx_t_5numpy_uint32_t *) ( /* dim=0 */ (__pyx_v_hist.data + __pyx_t_14 * __pyx_v_hist.strides[0]) )) += 1;
            ...
            /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":69
 *                 bin = <Py_ssize_t> (bin_factor * (v - hist_min))
 *                 hist[bin] += 1
 *                 if v < min_max[0]:             # <<<<<<<<<<<<<<
 *                     min_max[0] = v
 ...
 */
            ...
            if (__pyx_t_16) {
              ...
              /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":70
 *                 hist[bin] += 1
 *                 if v < min_max[0]:
 *                     min_max[0] = v             # <<<<<<<<<<<<<<
 *                 elif v > min_max[1]:
 ...
 */
            ...
            /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":71
 *                 if v < min_max[0]:
 *                     min_max[0] = v
 *                 elif v > min_max[1]:             # <<<<<<<<<<<<<<
 *                     min_max[1] = v
 */
            ...
            if (__pyx_t_16) {
              ...
              /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":72
 *                     min_max[0] = v
 *                 elif v > min_max[1]:
 *                     min_max[1] = v             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":27
 * import cython
 * cimport numpy
 * import numpy             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ris_widget/image/ndimage_statistics/_ndimage_statistics.pyx":1
 * # The MIT License (MIT)             # <<<<<<<<<<<<<<
 * #
